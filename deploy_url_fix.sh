...
echo "🚀 Deploying Dodo Payments URL fix to production..."
...
echo "🔨 Building backend with URL fix..."
...
if docker ps | grep -q englishgpt-api; then
    ...
    echo "🔗 Backend URL fixed - now using base URL directly without /api suffix"
