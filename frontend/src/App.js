...
const Dashboard = ({ questionTypes, onStartQuestion, onPricing, onHistory, onAnalytics, onAccountSettings, userStats, user, darkMode, onSignOut }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="lg:hidden flex items-center space-x-2">
              ...
              {!hasUnlimitedAccess() && userStats.questionsMarked === 0 && (
                <div className="bg-blue-100 text-blue-700 px-2 py-1 rounded-full">
                  <span className="font-fredoka text-xs">🎉 3 credits!</span>
                </div>
              )}
            </div>
      ...
      return (
        <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-main'} flex items-center justify-center`}>
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <h1 className="text-3xl font-fredoka font-bold mb-4">Welcome to EnglishGPT</h1>
            <p className="text-lg mb-8 font-fredoka">Your AI-powered English essay marking assistant</p>
            
            {/* Discord Login - Bigger and on top */}
            <button
              onClick={signInWithDiscord}
              className="bg-[#5865F2] text-white px-10 py-4 rounded-xl font-semibold hover:bg-[#4752C4] transition-colors flex items-center justify-center mx-auto mb-4 w-full max-w-sm text-lg"
            >
            ...
            {/* Google Login - Smaller and below */}
            <button
              onClick={signInWithGoogle}
              className="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center mx-auto w-full max-w-xs text-sm"
            >
