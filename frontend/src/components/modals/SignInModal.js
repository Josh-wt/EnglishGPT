      ...
      >
        ...
        <div className="text-center mb-6">
          <h3 className="text-2xl font-fredoka font-bold text-gray-900 mb-3">
            Ready to Start a New Essay?
          </h3>
          <p className="text-gray-600 leading-relaxed">
            Sign in to access our AI-powered essay marking tool and get instant, detailed feedback on your writing!
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-6">
          <div className="space-y-2">
            ...
            <div className="flex items-center text-sm text-gray-700">
              ...
              <span>3 free evaluations to start</span>
            </div>
          </div>
        </div>
